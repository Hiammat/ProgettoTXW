         ...
         <section class="py-5"><div class="container px-4 px-lg-5 my-5">
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6 text-center text-md-start">
                        <img class="card-img-top mb-5 mb-md-0 rounded shadow" src="assets/img/seven.png"  style="max-height: 600px; width: auto; object-fit: contain;" />
                    </div>
                    <div class="col-md-6">
                            <div class="small mb-1 text-white-50">Thriller/Giallo • 1995 • 127 min</div>
                        <h1 class="display-5 fw-bolder text-white mb-2">Seven</h1>
                        ...
                        <p class="lead text-white-50 mb-4">Seven &egrave; un thriller cupo e inquietante che segue due detective sulle tracce di un serial killer ispirato ai sette peccati capitali. Con un&apos;atmosfera opprimente e una tensione crescente, il film esplora il lato pi&ugrave; oscuro della mente umana, fino a un finale diventato indimenticabile.</p>                        
