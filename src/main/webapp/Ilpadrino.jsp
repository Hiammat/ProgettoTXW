                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<div class="d-flex gap-2">
					    ...
					    %>
					        ...
					        <a href="registrazione.jsp" class="btn btnlightPurple">Registrati</a>
         ...
         <section class="py-5"><div class="container px-4 px-lg-5 my-5">
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6 text-center text-md-start">
                        <img class="card-img-top mb-5 mb-md-0 rounded shadow" src="assets/img/ILPADRINO.png"  style="max-height: 600px; width: auto; object-fit: contain;" />
                    </div>
                    <div class="col-md-6">
                            <div class="small mb-1 text-white-50">Giallo/Crime • 1972 • 175 min</div>
                        <h1 class="display-5 fw-bolder text-white mb-2">Il Padrrino</h1>
...
<p class="lead text-white-50 mb-4">Il Padrino &egrave; un capolavoro del cinema gangster che racconta l&apos;ascesa e le dinamiche interne della famiglia mafiosa Corleone nella New York degli anni &apos;40. Tra potere, tradimenti e legami familiari, il film esplora il confine sottile tra affari e morale, grazie a una narrazione intensa e interpretazioni diventate leggendarie.</p>                        
