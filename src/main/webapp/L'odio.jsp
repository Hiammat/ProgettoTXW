        ...
        <section class="py-5 border-top border-secondary" style="background-color: #0B0B0D;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6">  
<img class="card-img-top mb-5 mb-md-0 rounded shadow" src="assets/img/L'odio.png"  style="max-height: 600px; width: auto; object-fit: contain;" />                    </div>
                    <div class="col-md-6">
                        <div class="small mb-1 text-white">SKU: BST-498</div>
                        <h1 class="display-5 fw-bolder text-white">L'odio</h1>
