            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="d-flex gap-2">
					    ...
					    %>
					        <a href="login.jsp" class="btn btn-outline-lightPurple">Accedi</a>
        ...
        <section class="py-5"><div class="container px-4 px-lg-5 my-5">
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6 text-center text-md-start">
                        <img class="card-img-top mb-5 mb-md-0 rounded shadow" src="assets/img/L'odio.png"  style="max-height: 600px; width: auto; object-fit: contain;" />
                    </div>
                    <div class="col-md-6">
                            <div class="small mb-1 text-white-50">Dramma • 1996 • 99 min</div>
                        <h1 class="display-5 fw-bolder text-white mb-2">L'odio</h1>
                        ...
                        <p class="lead text-white-50 mb-4">L&apos;odio &egrave; un intenso dramma sociale ambientato nelle periferie parigine, che segue ventiquattr&apos;ore nella vita di tre giovani amici dopo una notte di rivolte urbane. Con uno stile realistico e una forte tensione narrativa, il film affronta temi come emarginazione, violenza e disagio giovanile, diventando uno dei manifesti del cinema francese degli anni &apos;90.</p>
