         ...
         <section class="py-5"><div class="container px-4 px-lg-5 my-5">
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6 text-center text-md-start">
                        <img class="card-img-top mb-5 mb-md-0 rounded shadow" src="assets/img/lotr.png"  style="max-height: 600px; width: auto; object-fit: contain;" />
                    </div>
                    <div class="col-md-6">
                            <div class="small mb-1 text-white-50">Fantasy • 2001 • 178 min</div>
                        <h1 class="display-5 fw-bolder text-white mb-2">Il Signore degli Anelli: La Compagnia dell&apos;Anello </h1>
                        ...
                        <p class="lead text-white-50 mb-4">Il Signore degli Anelli: La Compagnia dell&apos;Anello &egrave; un&apos;avventura fantasy epica che segue il giovane Frodo Baggins nel suo viaggio per distruggere un potente anello. Tra amicizia, coraggio e grandi battaglie, il film introduce un mondo ricco di magia e pericoli, diventando uno dei capisaldi del cinema fantasy.</p>                        
